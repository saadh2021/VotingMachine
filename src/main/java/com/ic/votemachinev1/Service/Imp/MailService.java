...
public class MailService {
    ...
    public boolean sendVerificationEmail(String recipientEmail, int otpCode) {
        try {
            ...
            helper.setSubject("OTP Verification from Voting Machine");
            ...
            String htmlContent = "<!DOCTYPE html>"
                    ...
                    "                <h2 style=\"margin-top: 20px; color: #333;\">Voting System</h2>\n" +
                    ...
                    "                <p style=\"font-size: 14px; color: #666;\">Thank you for using E-Voting System</p>\n" +
                    "            </td>\n" +
                    "        </tr>\n" +
                    "    </table>"
                    + "</body>"
